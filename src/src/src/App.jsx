...
const FutureCard = ({ future }) => {
  ...
  return (
    <div className="transition-all duration-700 opacity-0 translate-y-3 animate-cardFadeIn bg-gray-800/50 rounded-2xl p-8 backdrop-blur-sm border border-gray-700/50">
    ...
    <div className="relative flex justify-center items-center">
      ...
      <div
        className={`relative z-10 transition-all duration-700 ${
          isActive ? 'scale-100 opacity-100 animate-avatarPop' : 'scale-90 opacity-0'
        }`}
      >
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-gray-900 via-gray-800 to-gray-900 text-white relative">
      ...
      <section className="min-h-screen flex flex-col items-center justify-center px-6 text-center pt-[clamp(5rem,12vh,8rem)] pb-20">
        ...
        <p
          className="text-xl lg:text-2xl text-gray-300 mb-12 max-w-2xl mx-auto animate-fade-in-up"
      ...
      {/* Futures */}
      <section className="pt-20 pb-12 px-6 bg-gray-800/30">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="w-16 h-0.5 bg-white/20 mx-auto mt-6 mb-8 rounded-full"></div>
      ...
      <section className="pt-12 pb-20 px-6">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="mx-auto mt-4 mb-10 w-16 h-[2px] bg-white/20 rounded-full" />
      ...
      {/* Footer minimalista de firma */}
      <footer className="text-center text-white/40 text-sm py-10 mt-0 border-t border-white/10">
